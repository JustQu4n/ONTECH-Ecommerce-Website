                                    ...
                                    <tbody>
                                        @foreach ($all_product as $key => $item_show)
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <p>{{ number_format($item_show->product_price) }}</p>
                                                </td>
                                                <td class="min-width">
                                                    <p>{{number_format($item_show->product_price_sell) }}</p>
                                                </td>
                                                {{-- <td class="min-width">
                                                    <p>{{number_format($item_show->product_price_sale) }}</p>
                                                </td> --}}
                                                ...
                                                <td>
                                                    <div class="action">
                                                        ...
                                                        <a onclick="return confirm('Are you sure to delete?')"
                                                            href="{{ URL::to('delete-product/' . $item_show->product_id) }}"
                                                            style="color:red"><i class="fas fa-times"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
