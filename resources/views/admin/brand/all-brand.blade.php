                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="min-width">
                        <img
                              src="{{asset('upload/brandImage/'.$value_show->brand_image)}}"alt="" width="80px" height="80px" />
                      </td>
                      <td class="min-width">
                        <?php 
                      ...
                      <td>
                        <div class="action">
                            <a href="{{URL::to('edit-brand/'.$value_show->brand_id)}}" class="mr-10" >Sửa</a>
                             <a  onclick="return confirm('Are you sure to delete?')" href="{{URL::to('delete-brand/'.$value_show->brand_id)}}" style="color:red" ><i class="fas fa-times"></i></a>
                        </div>
                      </td>
                    </tr>
                   @endforeach
