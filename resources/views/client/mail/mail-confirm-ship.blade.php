            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="invoice p-5">
                        <h5>Xác nhận đơn hàng!</h5> <span class="font-weight-bold d-block mt-4">Hello,{{$shipping_array['shipping_name']}}</span>
                                ...
                                <table class="table table-borderless">
                                    <tbody class="totals">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-right"> <span>@if ($shipping_array['feeship']=="")
                                                    25.000 VND
                                                    @else  
                                                    {{number_format($shipping_array['feeship'])}}
                                                @endif</span> </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="border-top border-bottom">
                                            ...
                                            <td>
                                                ...
                                                $feeship = $shipping_array['feeship'];
                                            
                                                $total_coupon = ($total*$_SESSION['coupon']['coupon_number'])/100;
                                                $total_after_coupon = $total-$total_coupon;
                                                $total_final = $total_after_coupon + $feeship ;
